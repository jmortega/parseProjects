...
public class Favorites {
  ...
  public static interface Listener {
    void onFavoriteAdded(Ponencia talk);

    void onFavoriteRemoved(Ponencia talk);
  }
  ...
  private void setJSON(JSONObject json) {
    ...
    ArrayList<Ponencia> toRemove = new ArrayList<Ponencia>();
    for (String objectId : talkIds) {
    	Ponencia pointer = Ponencia.createWithoutData(Ponencia.class, objectId);
      toRemove.add(pointer);
    }
    for (Ponencia talk : toRemove) {
      remove(talk);
    }
   ...
   */
  public boolean contains(Ponencia talk) {
   ...
   */
  public void remove(Ponencia talk) {
